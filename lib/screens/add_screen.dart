  ...
  void _save() async {
    ...
    if (p.cruiserIdentifier.trim().isEmpty || p.manufacturer.trim().isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            'Cruiser ID and Manufacturer are required.',
          ...
          return Expanded(
            child: Padding(
              padding: EdgeInsets.only(
                right: i < _pageTitles.length - 1 ? 6.w : 0,
              ),
              child: Column(
      ...
      child: Column(
        ...
        children: [
          ...
          _enumChips<String>(
            ...
            onSelected: (v) {
              _eraCtrl.text = v;
              ref.read(inputProvider).eraOfProduction = v;
            },
            label: (v) => v,
            color: (_) => kGold,
          ),
      ...
      child: Column(
        ...
        children: [
          ...
          _field(
            ...
            ctrl: _accCtrl,
            hint:
                'e.g. Original leather scabbard, cleaning rods, sharpening stone',
            maxLines: 2,
            ...
            return GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(kRadiusSubtle),
                  border: Border.all(
                    color: isSel ? color.withAlpha(120) : kOutline,
                    width: isSel ? 1.5 : 1,
                  ),
                ),
                child: Row(
        ...
        child: imgPath != null && File(imgPath).existsSync()
            ...
            : Column(
                ...
                children: [
                  ...
                  SizedBox(height: 4.h),
                  Text(
                    'Scale face, markings, and manufacturer text',
                    style: GoogleFonts.inter(
